-- STEP 2: Delete all user data (run this AFTER checking what exists)
-- Only run this if you're sure you want to delete everything

-- Show what we're about to delete
SELECT 'ABOUT TO DELETE - Current data counts:' as status;
...
-- NOW DELETE THE DATA (in correct order to avoid foreign key constraints)
...
SELECT 'AFTER DELETION - Remaining data counts:' as status;
