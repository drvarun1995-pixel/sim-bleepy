-- =====================================================
-- SIMPLE FIX FOR EVENTS_WITH_DETAILS VIEW - ORGANIZERS ONLY
-- =====================================================
-- This creates a simple view that properly handles additional organizers
-- =====================================================
...
-- Create a simple view that properly handles organizers
...
SELECT 
  ...
  -- All organizers combined (main + additional) for easy frontend use
  CASE 
    WHEN e.other_organizer_ids IS NOT NULL AND array_length(e.other_organizer_ids, 1) > 0
    THEN json_agg(
      DISTINCT jsonb_build_object(
