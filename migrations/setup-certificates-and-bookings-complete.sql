-- =====================================================
-- COMPLETE SETUP: CERTIFICATES + BOOKINGS + RLS
-- =====================================================
-- This script sets up both certificate and booking systems with proper RLS
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '=====================================================';
  RAISE NOTICE 'SETTING UP CERTIFICATES + BOOKINGS + RLS SYSTEMS';
  RAISE NOTICE '=====================================================';
  RAISE NOTICE 'This will create:';
  RAISE NOTICE '  ✓ Certificates system with RLS';
...
DO $$
BEGIN
  RAISE NOTICE 'PART 1/3: Creating Certificates System...';
END $$;
...
DO $$
BEGIN
  RAISE NOTICE 'PART 2/3: Creating Booking System...';
END $$;
...
DO $$
BEGIN
  RAISE NOTICE 'PART 3/3: Setting up Storage Policies...';
  RAISE NOTICE 'NOTE: You need to manually create the "certificates" storage bucket';
  RAISE NOTICE 'and add these policies in the Supabase Storage section.';
END $$;

-- Note: Storage policies need to be added manually in Supabase Dashboard
-- Go to Storage → certificates bucket → Policies and add these:

-- Policy 1: Users can download own certificates
...
BEGIN
  ...
  RAISE NOTICE '  1. Create "certificates" storage bucket in Supabase';
  RAISE NOTICE '  2. Add the 3 storage policies (see comments above)';
  RAISE NOTICE '  3. Test the systems!';
  RAISE NOTICE '';
  RAISE NOTICE '=====================================================';
