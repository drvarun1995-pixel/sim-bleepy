-- Fix missing booking_status field in event_booking_stats view
-- This migration adds the missing booking_status computed field that the frontend expects

-- Drop the existing view
DROP VIEW IF EXISTS event_booking_stats;

-- Recreate the view with the missing booking_status field
