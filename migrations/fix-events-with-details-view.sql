-- =====================================================
-- FIX EVENTS_WITH_DETAILS VIEW - REMOVE NON-EXISTENT COLUMNS
-- =====================================================
-- This fixes the view by removing references to columns that don't exist
-- =====================================================
...
SELECT 
  ...
  -- Organizer details (only name, no email/phone if they don't exist)
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Fixed: Removed non-existent organizer.email and organizer.phone columns';
