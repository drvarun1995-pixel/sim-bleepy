...
import { ArrowLeft, Construction, Link as LinkIcon, Zap, Shield, Database } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Connect Bleepy Simulator with your existing medical training infrastructure and learning management systems.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[
              ...
              },
              {
                ...
                description: "Custom assessment platforms",
                status: "Coming Soon"
              }
          ...
          <div className="bg-gradient-to-r from-purple-600/10 to-blue-600/10 rounded-2xl p-8 border border-purple-200">
            ...
            <p className="text-gray-600 mb-6">
              Don't see your platform? Let us know what integration you need!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                type="text"
                placeholder="Platform or system name"
