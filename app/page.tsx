...
export default function HomePage() {
  ...
  return (
    <div className="bg-white">
      ...
      <section id="calendar" className="py-8 sm:py-10 bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="py-8 sm:py-10 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 relative overflow-hidden">
