...
function PublicQRScannerPage() {
  ...
  const handleQRCodeDetected = async (qrCodeData: string) => {
    ...
    try {
      const response = await fetch('/api/qr-codes/scan-public', {
        method: 'POST',
        headers: {
                ...
                {!userEmail && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="flex items-center gap-2 text-blue-800 mb-3">
                      ...
                      <span className="font-medium">User Information Required</span>
                    </div>
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-medium text-gray-900 mb-2">Allow Camera Access</h3>
                <p className="text-sm text-gray-600">
                  Grant camera permission when prompted to enable QR code scanning
                </p>
              </div>
...
function PublicQRScannerPageWithSuspense() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
...
export default PublicQRScannerPageWithSuspense
