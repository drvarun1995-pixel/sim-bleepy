...
export default function MedEdTeamDashboard() {
  ...
  if (loading) {
    return <LoadingScreen message="Loading MedEd Team Dashboard..." />;
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">MedEd Team Dashboard</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                onClick={() => router.push('/dashboard/meded_team/profile')}
                variant="outline"
                size="sm"
              >
