...
export const metadata: Metadata = {
  ...
  description: 'Staff management of presentation opportunities.',
...
export default async function ConferenceDataLayout({ children }: { children: React.ReactNode }) {
  const session = await getServerSession(authOptions)
  if (!session?.user) {
    redirect('/auth/signin?callbackUrl=/conference-data')
  }
