...
-- This script ensures all gamification tables, functions, and data exist
...
('first_scenario', 'First Steps', 'Complete your first clinical scenario', '🎯', 100),
('perfect_score', 'Perfectionist', 'Achieve a perfect score (12/12)', '⭐', 200),
('speed_demon', 'Speed Demon', 'Complete a scenario in under 5 minutes', '⚡', 200),
('scenario_master', 'Scenario Master', 'Complete 50 scenarios', '🏆', 500),
('perfectionist', 'Perfectionist', 'Achieve 10 perfect scores', '💎', 600),
('week_warrior', 'Week Warrior', 'Practice for 7 consecutive days', '📅', 300),
('month_master', 'Month Master', 'Practice for 30 consecutive days', '🗓️', 1000),
('early_bird', 'Early Bird', 'Complete your first scenario before 8 AM', '🌅', 150),
('night_owl', 'Night Owl', 'Complete a scenario after 10 PM', '🦉', 150),
('weekend_warrior', 'Weekend Warrior', 'Complete scenarios on both weekend days', '🏁', 200)
...
-- 7. Initialize existing users in gamification system
INSERT INTO user_levels (user_id, current_level, total_xp, level_progress, title)
SELECT 
    u.id, 
    1, 
...
BEGIN
    ...
    IF test_user_id IS NOT NULL THEN
        RAISE NOTICE 'Testing gamification functions with user: %', test_user_id;
        ...
        -- Show final user level
        SELECT current_level, total_xp, title 
        INTO test_user_id, test_user_id, test_user_id
        FROM user_levels 
        WHERE user_id = test_user_id;
        
        RAISE NOTICE 'Final user level: Level %, XP: %, Title: %', 
