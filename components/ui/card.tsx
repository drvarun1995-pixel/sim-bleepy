  ...
  "rounded-lg border bg-card text-card-foreground shadow-sm",
  {
    variants: {
      variant: {
        ...
        interactive: "border-border shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300 cursor-pointer",
        success: "bg-gradient-to-r from-green-100 to-emerald-100 border-green-200 shadow-lg"
      },
      size: {
        default: "p-6",
        sm: "p-4",
